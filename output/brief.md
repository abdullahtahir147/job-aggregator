...
**Run:** `412a3131f0c7` | 2026-04-13T10:51:14Z
**Companies:** 133 | **Jobs:** 13307 | **New:** 396 | **New UK:** 61 | **Unknown ATS:** 18
**Freshness filter:** <= 7d | **Filtered out by age:** 0

## Apply Now

- **Intercom — Senior Data Scientist - Product Analytics** [PRODUCT_GROWTH_DATA]  Score: 16 (base 6, Δ+10) | 0d old
  London, England
  Why: title match: 'data scientist'; title match: 'product analytics'; keyword: 'experiment' (+2 more) | boost: product analytics (+2); boost: experimentation (+3); boost: growth (+1... | very recent (0d)
...
- **Deliveroo — Senior Data Scientist - Experimentation** [PRODUCT_GROWTH_DATA]  Score: 14 (base 8, Δ+6) | 0d old
  London - The River Building HQ
  Why: title match: 'data scientist'; title match: 'experimentation'; keyword: 'experiment' (+1 more) | boost: experimentation (+3) | very recent (0d)
...
- **Deliveroo — Senior Product Data Scientist ** [CORE_DS]  Score: 10 (base 6, Δ+4) | 0d old
  London - The River Building HQ
  Why: title match: 'product data scientist'; title match: 'data scientist' | boost: product (+1) | very recent (0d)
  [Apply](https://jobs.ashbyhq.com/deliveroo/8074e2e7-f9b6-4f6c-9b9c-5576e526002a)

## Worth a Look

- **Intercom — Forward Deployed Software Engineer** [APPLIED_AI_FDE]  Score: 10 (base 1, Δ+9) | 0d old
  London, England
  Why: title match: 'forward deployed'; exclude kw: 'platform' | boost: forward deployed (+4); boost: applied ai (+4); boost: product (+1); pe... | very recent (0d)
  [Apply](https://job-boards.greenhouse.io/intercom/jobs/7556413)

- **Lendable — Lead Product Data Scientist** [CORE_DS]  Score: 10 (base 6, Δ+4) | 0d old
  London
  Why: title match: 'product data scientist'; title match: 'data scientist' | boost: product (+1) | very recent (0d)
  [Apply](https://jobs.ashbyhq.com/lendable/acf4456d-f054-4966-b04d-768c245b3fde)

- **Lendable — Senior Product Data Scientist** [CORE_DS]  Score: 10 (base 6, Δ+4) | 0d old
  London
  Why: title match: 'product data scientist'; title match: 'data scientist' | boost: product (+1) | very recent (0d)
  [Apply](https://jobs.ashbyhq.com/lendable/09eedc0b-88c0-4b3c-8d51-65e0f05b721a)

- **OpenAI — Technical Deployment Lead, Forward Deployed Engineering - London** [APPLIED_AI_FDE]  Score: 10 (base 3, Δ+7) | 0d old
  London, UK
  Why: title match: 'forward deployed' | boost: forward deployed (+4) | very recent (0d)
  [Apply](https://jobs.ashbyhq.com/openai/2c16575f-1a04-43af-bd0a-8e8f72e3255f)

- **OpenAI — Forward Deployed Engineer - London** [APPLIED_AI_FDE]  Score: 10 (base 3, Δ+7) | 0d old
  London, UK
  Why: title match: 'forward deployed' | boost: forward deployed (+4) | very recent (0d)
  [Apply](https://jobs.ashbyhq.com/openai/cf83e70e-6949-480f-ad97-df0f22cd0283)

- **OpenAI — Forward Deployed Software Engineer - London** [APPLIED_AI_FDE]  Score: 10 (base 3, Δ+7) | 0d old
  London, UK
  Why: title match: 'forward deployed' | boost: forward deployed (+4) | very recent (0d)
  [Apply](https://jobs.ashbyhq.com/openai/54b2072e-4c1c-40e4-b2dc-ec51d9d0ab60)

- **OpenAI — Forward Deployed Engineer (FDE), Life Sciences - London** [APPLIED_AI_FDE]  Score: 10 (base 3, Δ+7) | 0d old
  London, UK
  Why: title match: 'forward deployed' | boost: forward deployed (+4) | very recent (0d)
  [Apply](https://jobs.ashbyhq.com/openai/d2ab1c9b-5c0c-4b43-a7c3-c9301854c023)

- **OpenAI — Sourcer, Forward Deployed Engineering - London** [APPLIED_AI_FDE]  Score: 10 (base 3, Δ+7) | 0d old
  London, UK
  Why: title match: 'forward deployed' | boost: forward deployed (+4) | very recent (0d)
